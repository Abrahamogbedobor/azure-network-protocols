...
- Creatin Virtual Network
- Creating Subnet
- Creating two Virtual Machine on two Operating System Windows(W-10) and Linus(Ubuntu) with Network Security Group attached i.e firewall
- Examining of Traffic between both Virtual Machines Using Protocol Analyser (Wireshark)
